...
(function initThreeBackground() {
    ...
    if (typeof THREE === 'undefined') {
        console.error('Three.js library not loaded. Check your internet connection or CDN link.');
        return;
    }
...
function navigateTo(pageId) {
    ...
    // Trigger content rendering if needed
...
function renderAboutSkills() {
    ...
    // Animate bars after they're added
    setTimeout(() => {
...
const projectsData = [
    ...
    },
    {
        ...
        desc: 'A fully responsive portfolio website built with React.js and Tailwind CSS. Showcases projects, skills, and contact information with smooth animations.',
